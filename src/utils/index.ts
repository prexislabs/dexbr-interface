...
import { abi as IUniswapV2Router02ABI } from 'dexbr-v2-periphery/build/UniswapV2Router02.json'
import { ROUTER_ADDRESS } from '../constants'
import { ALL_TOKENS } from '../constants/tokens'
import { ChainId, JSBI, Percent, TokenAmount, Token } from 'dexbr-sdk'
...
// account is optional
export function getProviderOrSigner(library: Web3Provider, account?: string): any | JsonRpcSigner {
